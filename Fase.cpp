...
namespace Game
{
	namespace Fases
	{
		...
		Fase::Fase():
			...
			fogo(new Entidades::Obstaculos::Obstaculo(Vector2F(2300.0f, 750.0f), "assets/fogo1.png")),// fazer a classe fogo com eles randomizados feat dando dano e feat anima��o
