...
namespace Jogo
{
	namespace Fases
	{
		Fase_1::Fase_1() :
			...
			o6(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1500.0f, 700.0f), "assets/rectangle6.png")),
			o7(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1550.0f, 680.0f), "assets/rectangle6.png")),
			o8(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1600.0f, 660.0f), "assets/rectangle6.png")),
			o9(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1650.0f, 640.0f), "assets/rectangle6.png")),
			o10(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1700.0f, 620.0f), "assets/rectangle6.png")),
			o11(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1750.0f, 640.0f), "assets/rectangle6.png")),
			o12(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1800.0f, 660.0f), "assets/rectangle6.png")),
			o13(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1850.0f, 680.0f), "assets/rectangle6.png")),
			o14(new Entidades::Obstaculos::Obstaculo(IDsEntidades::obstaculo, Vector2F(1900.0f, 700.0f), "assets/rectangle6.png")),
