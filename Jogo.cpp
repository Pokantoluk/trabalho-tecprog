...
namespace Game 
{
	Jogo::Jogo()
	{
		...
		entidades.inserir(new Entidades::Inimigo(Vector2F(300.0f, 50.0f), Vector2F(0.0f, 0.0f), "assets/goomba.png"));
		//entidades.inserir(new Entidades::Obstaculos::Obstaculo(Vector2F(300.0f,720.0f), "assets/piso.png"));
